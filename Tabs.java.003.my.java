...
public class Tabs implements BundleEventListener {
    private static final String myHome = "ip.jjj123.com";
    ...
    private static String getHomepageForNewTab(Context context) {
        ...
        return forEveryNewTab ? getHomepageForStartupTab(context) : myHome;
    }
    ...
    public static String getHomepageForStartupTab(Context context) {
        ...
        return TextUtils.isEmpty(homepage) ? myHome : homepage;
    }
    ...
    public static String getHomepage(Context context) {
        ...
        final String homepagePreference = preferences.getString(GeckoPreferences.PREFS_HOMEPAGE, myHome );
